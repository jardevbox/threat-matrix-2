...
*    Release: https://github.com/spring-projects/spring-boot/releases/tag/v1.5.3.RELEASE
...
private class SpringApplicationRunnerConfigurationAdapter extends OptionSetGroovyCompilerConfiguration
    ...
    @Override
    public GroovyCompilerScope getScope2() {
        return GroovyCompilerScope.DEFAULT;
    }

    @Override
    public boolean isWatchForFileChanges2() {
