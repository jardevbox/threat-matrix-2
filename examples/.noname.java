...
*    
*    Repositories:
*     - repo:  release version: v1.4.0.M2  asset relative path: spring-boot-cli/src/main/java/org/springframework/boot/cli/command/options/SourceOptions.java
*     - repo:  release version: v1  asset relative path: src/main/java/org/apache/commons/codec/binary/Base64.java
